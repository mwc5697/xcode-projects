...
// *** Notice ***
// OHCircleSegue is available under the MIT license.
// THIS CODE IS NOT MY CODE. I basically used this code to perform transition animations.
// from https://github.com/oyvinddd/ohcirclesegue

import UIKit

class OHCircleSegue: UIStoryboardSegue, CAAnimationDelegate {
    
    private static let expandDur: CFTimeInterval = 1 // Change to make transition faster/slower
    private static let contractDur: CFTimeInterval = 1 // Change to make transition faster/slower
